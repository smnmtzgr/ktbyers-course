...
# get vendor, model, os_version, uptime, serial_number
# generic string parsing -> should work for other cisco devices
#
# Strings to look for:
...
for line in show_ver_list:
    if 'Cisco IOS Software' in line:
        ...
        router_dict['os_version'] = os_version.split()[1]

    if 'bytes of memory' in line:
        router_dict['model'] = line.split()[1]

    if 'Processor board ID' in line:
        router_dict['serial_number'] = line.split()[3]
